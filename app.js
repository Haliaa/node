//шифрування - є зворотнім (можна назад розшифрувати)
//хешування - НЕ є зворотнім (НЕ можна назад розшифрувати), але
//можна знайти хешсуму, порахувати хешсуму і так дізнаємось паролі однакові чи нє
